...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium hover:bg-[#61CAFF] hover:text-white focus:bg-[#61CAFF] focus:text-white disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover:bg-[#61CAFF] data-[state=open]:text-white data-[state=open]:focus:bg-[#61CAFF] data-[state=open]:bg-[#61CAFF]/50 focus-visible:ring-ring/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1"
);
